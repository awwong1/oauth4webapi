> NOTE: This is a fork of the original [panva/oauth4webapi](https://github.com/panva/oauth4webapi) repository with a modification to output commonjs. See also https://github.com/auth0/nextjs-auth0/issues/1752
